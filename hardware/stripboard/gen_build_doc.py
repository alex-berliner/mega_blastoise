...
w('Then the headers:')
w('')
w('- **P1 OLED**: header at hole 27, screen hangs DOWN (rows 27-37). Pin order')
w(f'  left to right: GND={P(9,27)}, VCC={P(10,27)}, SCL={P(11,27)}, SDA={P(12,27)}.')
w('- **P2 OLED**: rotated 180 deg - header at hole 18, screen hangs UP (rows')
w(f'  8-18). Pin order left to right: SDA={P(9,18)}, SCL={P(10,18)}, VCC={P(11,18)}, GND={P(12,18)}.')
...
w('')
w(f'4. **OLEDs**: SDA/SCL of each header to Pico pins - P1: {P(12,27)}-pin21(GP16),')
w(f'   {P(11,27)}-pin22(GP17); P2: {P(9,18)}-pin24(GP18), {P(10,18)}-pin25(GP19).')
