...
w('## 8. Firmware note')
w('')
w("- No display flip needed: P2's OLED is physically rotated 180 deg AND P2")
w('  views the board from the opposite side - the two rotations cancel, so the')
w('  firmware renders both displays identically.')
